def set_template(args):
    if args.template is None:
        ...
        # No negative sampling needed — DDBC eval uses shared candidate files
        ...
        args.bert_max_len      = 10   # Yelp sequence length
        args.bert_num_blocks   = 2
        args.bert_num_heads    = 4

        # DDBC eval
        args.predict_nums           = '3,5'
        args.candidate_multipliers  = '9,19,49,99'
        args.topk                   = 1
        args.eval_freq              = 5
        args.patience               = 10
